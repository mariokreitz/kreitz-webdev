...
> **Design Companion:** This skill provides the _technical implementation_ for scroll-driven motion.
> For the _creative philosophy_, design principles, and premium aesthetics that should guide **how**
...
| Skill                   | Relationship                                                                                           |
| ----------------------- | ------------------------------------------------------------------------------------------------------ |
| **premium-frontend-ui** | Creative philosophy, design principles, and aesthetic guidelines — defines _when_ and _why_ to animate |
