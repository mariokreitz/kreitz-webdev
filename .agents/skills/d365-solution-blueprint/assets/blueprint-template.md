...
_Read this first when resuming. Update it at the end of every session._
...
_Indicative only. Verify against the current Dynamics 365 licensing documentation and the client's contracted entitlement._
...
_Include the calculated cost of not automating: hours per cycle x updates per year, ongoing._
...
_Validate the window against measured full-volume dry-run timings._
